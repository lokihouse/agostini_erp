...
ExportColumn::make('id')->label('ID'),
            ...
            ExportColumn::make('parent_uuid')->label('Parent Uuid')
        ];
    }

    public static function getCompletedNotificationBody(Export $export): string
    {
        $body = 'Your ChartOfAccount export has completed and ' . number_format($export->successful_rows) . ' ' . Str::plural('row', $export->successful_rows) . ' exported.';
    ...
    {
        return 'chart_of_accounts_' . $export->getKey() . '.xlsx';
    }
