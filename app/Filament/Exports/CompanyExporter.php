...
ExportColumn::make('id')->label('ID'),
            ...
            ExportColumn::make('socialName')->label('Social Name'),
            ExportColumn::make('taxNumber')->label('Tax Number'),
            ...
            ExportColumn::make('telephone')->label('Telephone')
        ];
    }

    public static function getCompletedNotificationBody(Export $export): string
    {
        $body = 'Your Company export has completed and ' . number_format($export->successful_rows) . ' ' . Str::plural('row', $export->successful_rows) . ' exported.';
    ...
    {
        return 'companies_' . $export->getKey() . '.xlsx';
    }
