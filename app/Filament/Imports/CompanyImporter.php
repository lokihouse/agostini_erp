...
class CompanyImporter extends Importer
{
    ...
    public function resolveRecord(): ?Company
    {
        ...
        //      $record = Company::find($this->data['id']);
        //      if ($record) {
        //          return $record;
        //      }
        // }
    ...
    {
        $body = 'Your Company import has completed and ' . number_format($import->successful_rows) . ' ' . Str::plural('row', $import->successful_rows) . ' imported.';
    ...
    // {
    //    return [
    //        // '*.email' => ['required', 'email', 'unique:'.Company::class.',email'],
    //    ];
    // }
