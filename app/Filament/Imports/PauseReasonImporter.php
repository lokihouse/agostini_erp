...
class PauseReasonImporter extends Importer
{
    ...
    public function resolveRecord(): ?PauseReason
    {
        ...
        //      $record = PauseReason::find($this->data['id']);
        //      if ($record) {
        //          return $record;
        //      }
        // }
    ...
    {
        $body = 'Your PauseReason import has completed and ' . number_format($import->successful_rows) . ' ' . Str::plural('row', $import->successful_rows) . ' imported.';
    ...
    // {
    //    return [
    //        // '*.email' => ['required', 'email', 'unique:'.PauseReason::class.',email'],
    //    ];
    // }
