...
class ProductionStepImporter extends Importer
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ImportColumn::make('description')
                ...
                ->requiredMapping()
                ->rules(['nullable', 'max:255']),
            ImportColumn::make('default_order')
                ->label('Default Order')
                ->requiredMapping()
                ->rules(['nullable', 'max:255'])
        ];
    ...
    public function resolveRecord(): ?ProductionStep
    {
        ...
        //      $record = ProductionStep::find($this->data['id']);
        //      if ($record) {
        //          return $record;
        //      }
        // }
        ...
        // // return ProductionStep::firstOrNew([
    ...
    {
        $body = 'Your ProductionStep import has completed and ' . number_format($import->successful_rows) . ' ' . Str::plural('row', $import->successful_rows) . ' imported.';
    ...
    // {
    //    return [
    //        // '*.email' => ['required', 'email', 'unique:'.ProductionStep::class.',email'],
    //    ];
    // }
