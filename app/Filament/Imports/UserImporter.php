...
class UserImporter extends Importer
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ImportColumn::make('work_shift_id')
                ->label('Work Shift Id')
                ->requiredMapping()
                ->rules(['nullable', 'max:255']),
    ...
    {
        $body = 'Your User import has completed and ' . number_format($import->successful_rows) . ' ' . Str::plural('row', $import->successful_rows) . ' imported.';
