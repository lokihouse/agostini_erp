...
class EquipamentoPolicy
{
    ...
    {
        return $user->can('view_any_equipamento');
    }
    ...
    {
        return $user->can('view_equipamento');
    }
    ...
    {
        return $user->can('create_equipamento');
    }
    ...
    {
        return $user->can('update_equipamento');
    }
    ...
    {
        return $user->can('delete_equipamento');
    }
    ...
    {
        return $user->can('delete_any_equipamento');
    }
     ...
     */
    public function replicate(User $user, Equipamento $equipamento): bool
    {
