...
class FuncionarioPolicy
{
    ...
    {
        return $user->can('view_any_funcionario');
    }
    ...
    {
        return $user->can('view_funcionario');
    }
    ...
    {
        return $user->can('create_funcionario');
    }
    ...
    {
        return $user->can('update_funcionario');
    }
    ...
    {
        return $user->can('delete_funcionario');
    }
    ...
    {
        return $user->can('delete_any_funcionario');
    }
     ...
     */
    public function replicate(User $user, Funcionario $funcionario): bool
    {
