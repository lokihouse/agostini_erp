...
class MovimentacaoPolicy
{
    ...
    {
        return $user->can('view_any_movimentacao');
    }
    ...
    {
        return $user->can('view_movimentacao');
    }
    ...
    {
        return $user->can('create_movimentacao');
    }
    ...
    {
        return $user->can('update_movimentacao');
    }
    ...
    {
        return $user->can('delete_movimentacao');
    }
    ...
    {
        return $user->can('delete_any_movimentacao');
    }
     ...
     */
    public function replicate(User $user, Movimentacao $movimentacao): bool
    {
