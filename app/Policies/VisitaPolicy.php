...
class VisitaPolicy
{
    ...
    {
        return $user->can('view_any_visita');
    }
    ...
    {
        return $user->can('delete_any_visita');
    }
     ...
     */
    public function replicate(User $user, Visita $visita): bool
    {
