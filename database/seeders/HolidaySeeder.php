...
class HolidaySeeder extends Seeder
{
    public function run(): void
    {
        ...
        Holiday::factory()->global('Sexta-feira Santa', Carbon::createFromTimestamp(easter_date($currentYear))->subDays(2)->format('Y-m-d'), 'national', false)->create();         Holiday::factory()->global('Páscoa', Carbon::createFromTimestamp(easter_date($currentYear))->format('Y-m-d'), 'national', false)->create();         Holiday::factory()->global('Tiradentes', "{$currentYear}-04-21")->create();
