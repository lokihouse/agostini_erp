            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    @foreach($reportData as $item)
                        {{-- Root Level --}}
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 font-bold text-gray-900 dark:text-white">
                        ...
                        @foreach($item->childAccounts as $firstChild)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 font-medium text-gray-700 dark:text-gray-300">
                                <td class="w-4 px-3 py-2 text-transparent">L</td>
                            ...
                            @foreach($firstChild->childAccounts as $secondChild)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-400">
                                    <td class="w-4 px-3 py-2 text-transparent">L</td>
                                    <td class="w-4 px-3 py-2 text-transparent">L</td>
                                ...
                                @foreach($secondChild->childAccounts as $thirdChild)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 font-thin text-gray-500 dark:text-gray-400">
                                        <td class="w-4 px-3 py-2 text-transparent">L</td>
                                        <td class="w-4 px-3 py-2 text-transparent">L</td>
                                        <td class="w-4 px-3 py-2 text-transparent">L</td>
                                        <td class="px-3 py-2">
